...
class analytic_line_plan_make_purchase_requisition(orm.TransientModel):
    _name = "analytic.line.plan.make.purchase.requisition"
    _description = "Analytic line plan make purchase requisition"
...
analytic_line_plan_make_purchase_requisition()