...
class PurchaseRequestLineMakePurchaseOrder(models.TransientModel):
    ...
    def _prepare_purchase_order(self, warehouse_id, company_id):
        ...
        supplier_pricelist = (
            supplier.property_product_pricelist_purchase or
            False
        )
        data = {
            'origin': '',
    ...
    def _prepare_purchase_order_line(self, po, item):
        ...
        supplier_pricelist = (
            po.partner_id.property_product_pricelist_purchase and
            po.partner_id.property_product_pricelist_purchase.id or
            False
        )
