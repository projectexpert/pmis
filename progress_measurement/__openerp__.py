...
------------------------------------
    ...
    A Progress Type is defined by the following attributes:
        ...
        * Maximum value: Maximum value that is permitted for the object being
          measured as a total measure of progress.
        * Precision: Value of increments permitted for the given progress
          type measured as a total measure of progress.
...
------------------------------------
    ...
    A Progress Measurement is defined by the following attributes:
        ...
        * Value: Results of the measurement. Must be defined in the precision
        ...
        The user cannot enter a value that exceeds the maximum permitted value
        for that progress type.
