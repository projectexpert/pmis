...
class risk_management_risk (osv.osv):
    ...
    _columns = {
        'name': fields.char(
            'Risk Id', size=64, required=True,
            readonly=True, states={'draft': [('readonly', False)]},
            select=True, help="Risk label. Can be changed as long as risk is in state 'draft'."
        ),
        ...
        'date_registered': fields.date(
            'Date Registered', required=True, help="Date of the Risk registered. Auto populated."
        ),
        ...
        'risk_category_id': fields.many2one(
            ...
            help="""
            Risk Category: The type of risk in terms of the project's or business' chosen categories
        ...
        'impact_inherent': fields.integer(
            ...
            help="""
            Impact: The result of a particular threat or opportunity actually occurring, or the anticipation of such
            a result. This is the pre-response value, common used scales are 1 to 10 or 1 to 100.
            """
        ),
        'impact_residual': fields.integer(
            ...
            help="""
            Impact: The result of a particular threat or opportunity actually occurring, or the anticipation of such
            a result. This is the post-response value, common used scales are 1 to 10 or 1 to 100.
            """
        ),
        'probability_inherent': fields.integer(
            'Inherent Probability', required=True,
            help="""
            Probability: The evaluated likelihood of a particular threat or opportunity actually happening, including
            a consideration of the frequency with which this may arise. This is the pre-response value, common used
            scales are 1 to 10 or 1 to 100.
            """
        ),
        'probability_residual': fields.integer(
            ...
            help="""
            Probability: The evaluated likelihood of a particular threat or opportunity actually happening, including
            a consideration of the frequency with which this may arise. This is the post-response value, common used
            scales are 1 to 10 or 1 to 100.
            """
        ),
        'expected_value_inherent': fields.function(
            _calculate_expected_inherent_value, method=True, string='Expected Inherent Value', store=True,
            help="Expected Value. Cost of inherent impact * inherent probability. This is the pre-response value."
        ),
        'expected_value_residual': fields.function(
            _calculate_expected_residual_value, method=True, string='Expected Residual Value', store=True,
        ...
        'proximity_id': fields.many2one(
            ...
            help="""
            Proximity: This would typically state how close to the present time the risk event is anticipated to
            happen (e.g. for project risks Imminent, within stage, within project, beyond project).  Proximity
            should be recorded in accordance with the project's chosen scales or business continuity time scales.
            """
        ),
        ...
        'risk_owner_id': fields.many2one(
            ...
            risk ownership is assigned to a managerial level, in case of business continuity to a C-level manager.
            """
        ),
    }
    _defaults = {
        ...
        for risk in risks:
            if 'risk_response_ids' in risk and risk['risk_response_ids']:
                ...
                task_ob.message_subscribe(
                    cr, uid, risk['risk_response_ids'], risk['message_follower_ids'], context=context
                )
