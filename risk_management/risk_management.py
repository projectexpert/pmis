...
class risk_management_risk (models.Model):
    ...
    probability_inherent = fields.Integer(
        ...
        help='''
        Probability: The evaluated likelihood of a particular threat or opportunity actually happening,
        including a consideration of the frequency with which this may arise. This is the pre-response value,
    ...
    probability_residual = fields.Integer(
        ...
        help='''
        Probability: The evaluated likelihood of a particular threat or opportunity actually happening,
        including a consideration of the frequency with which this may arise. This is the post-response value,
        common used scales are 1 to 10 or 1 to 100.
        '''
    )
    expected_value_inherent = fields.Float(
        compute='_calculate_expected_inherent_value', method=True, string='Expected Inherent Value', store=True,
        help='''
        Expected Value. Cost of inherent impact * inherent probability. This is the pre-response value.'''
    )
    expected_value_residual = fields.Float(
        compute='_calculate_expected_residual_value', method=True, string='Expected Residual Value', store=True,
        help='''
        Expected Value. Cost of residual impact * residual probability. This is the post-response value.
        '''
    )
    proximity_id = fields.Many2one(
        'risk.management.proximity', 'Proximity',
        help='''
        Proximity: This would typically state how close to the present time the risk event is anticipated to happen
        (e.g. for project risks Imminent, within stage, within project, beyond project). Proximity should be recorded
